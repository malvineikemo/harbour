  ...
  return (
    <div className="container mx-auto max-w-4xl py-12">
      ...
      <div className="prose prose-invert max-w-none">
        <p className="lead text-gray-200 text-lg">Last updated: March 7, 2025</p>
        ...
        <p>
          ...
          agree to be bound and abide by these Terms. If you do not want to agree to these Terms, you must not access or
          use the Service.
        </p>
        ...
        <p>
          We reserve the right to withdraw or amend the Service, and any service or material we provide on the Service,
        ...
        <p>
          ...
          and other interactive features that allow users to post, submit, publish, display, or transmit to other users
          or other persons content or materials on or through the Service.
        </p>
        <p>
        ...
        <h2>7. Termination</h2>
        <p>
          We may terminate or suspend your access to all or part of the Service, without notice, for any conduct that
          we, in our sole discretion, believe is in violation of any applicable law or is harmful to the interests of
          another user, a third-party, or us.
        </p>
        ...
        <p>
          ...
          USE, OR INABILITY TO USE, THE SERVICE, ANY WEBSITES LINKED TO IT, ANY CONTENT ON THE SERVICE OR SUCH OTHER
        ...
        <p>
          ...
          formation shall be governed by and construed in accordance with the laws of Norway, without giving effect to
          any choice or conflict of law provision or rule.
        </p>

        <h2>11. Contact Information</h2>
        <p>Questions or comments about the Service or these Terms may be directed to us at:</p>
        <p>
          Email: terms@harbour.eikemo.dev
          <br />
          Address: Eikemo Developments, Norway
        </p>
      </div>
    </div>
  )
